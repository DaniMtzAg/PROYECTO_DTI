...
% son:
% [:,1] = Anisotropía fraccional
% [:,2] = Difusividad media
% [:,3] = Difusividad axial
% [:,4] = Difusividad radial
% [:,5] = Score del MMSE
% [:,6] = Edad del sujeto
% [:,7] = Sexo del sujeto (codificado 0 = hombre, 1 =  mujer)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Matriz de datos para el grupo con enfermedad de Alzheimer;
data.ad(:,:) = [A.FA(categorical(A.Grupo) == 'AD_ADNI') ...
    A.DM(categorical(A.Grupo) == 'AD_ADNI') ...
...
data.cnad(:,:) = [A.FA(categorical(A.Grupo) == 'CNAD_ADNI') ...
    A.DM(categorical(A.Grupo) == 'CNAD_ADNI') ...
...
data.dcl(:,:) = [A.FA(categorical(A.Grupo) == 'DCL') ...
    A.DM(categorical(A.Grupo) == 'DCL') ...
...
data.cndcl(:,:) = [A.FA(categorical(A.Grupo) == 'CNDCL')...
    A.DM(categorical(A.Grupo) == 'CNDCL')...
...
data.por(:,:) = [A.FA(categorical(A.Grupo) == 'PORTADORES')...
    A.DM(categorical(A.Grupo) == 'PORTADORES')...
...
data.npor(:,:) = [A.FA((categorical(A.Grupo) == 'NO_PORTADORES') & A.Edad <= 48) ...
    A.DM((categorical(A.Grupo) == 'NO_PORTADORES') & A.Edad <= 48) ...
